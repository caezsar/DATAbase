        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><i class="fa fa-user"></i> Session ID:<strong> <?php echo $row['user_id']; ?></strong></span>
            </a>
...
<p>
      ...
      <form action="search.php" method="post" class="sidebar-form">
        <div class="input-group">
          <input type="text" name="names" class="form-control" placeholder="Search after name">
              <span class="input-group-btn">
                <button type="submit" name="submit" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i>
                </button>
              </span>
